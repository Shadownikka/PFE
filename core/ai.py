...
class NetMindAI:
    def __init__(self):
        ...
        self._start_time = None  # Monitoring start timestamp
        self.running = False
    ...
    def start_monitoring(self, mode='auto'):
        ...
        # Start local REST API for website integration
        print(colored("[+] Starting local REST API for website integration...", "cyan"))
        self._start_time = time.time()
        self._api_token = create_api(self)
        print(colored("  ✓ Website can now connect using the API token", "green"))
